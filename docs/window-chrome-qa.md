...
- The custom green traffic-light callback maps to macOS Zoom/maximize-restore (`zoom:`), not full-screen Space entry.
...
5. Green traffic light zooms/maximizes; pressing it again restores the previous size.
...
- **tracked:** green maximize/restore remains a known TODO-15 follow-up and is excluded from pixel scoring with explicit evidence.
